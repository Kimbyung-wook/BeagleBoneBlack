...
_0x0:
	.DB  0x25,0x64,0x2C,0x25,0x73,0x2C,0x30,0x3A
	.DB  0x25,0x64,0x2C,0x31,0x3A,0x25,0x64,0xA
	.DB  0x0
...
; 0000 0014     GetLine[Linecnt++] = UDR0;
	...
	INC  R4
	LDI  R31,0
	SUBI R30,LOW(-_GetLine)
	SBCI R31,HIGH(-_GetLine)
	MOVW R26,R30
	IN   R30,0xC
	ST   X,R30
; 0000 0015 }
...
; 0000 0061                 Linecomma[j++]=i;
	MOVW R30,R18
	__ADDWRN 18,19,1
	LDI  R26,LOW(_Linecomma)
	LDI  R27,HIGH(_Linecomma)
	LSL  R30
	ROL  R31
	ADD  R30,R26
	ADC  R31,R27
...
; 0000 0079             printf("%d,%s,0:%d,1:%d\n",Servo_duty[Select],GetLine,Linecomma[0],Linecomma[1]);
	...
	CLR  R23
	CALL __PUTPARD1
	LDI  R30,LOW(_GetLine)
	LDI  R31,HIGH(_GetLine)
	CLR  R22
	CLR  R23
	CALL __PUTPARD1
	LDS  R30,_Linecomma
...
SUBOPT_0x1:
	LDI  R26,LOW(_GetLine)
	LDI  R27,HIGH(_GetLine)
	ADD  R26,R16
	ADC  R27,R17
	LD   R26,X
	RET
